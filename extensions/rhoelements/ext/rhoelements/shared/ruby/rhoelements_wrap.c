...
#define SWIG_init    Init_Rhoelements
#define SWIG_name    "Rhoelements"

static VALUE mRhoelements;
...
SWIGINTERN VALUE
_wrap_native_process_string(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","native_process_string", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  result = (VALUE)native_process_string((char const *)arg1);
  vresult = result;
...
SWIGINTERN VALUE
_wrap_calc_summ(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","calc_summ", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","calc_summ", 2, argv[1] ));
  } 
  arg2 = (int)(val2);
  result = (int)calc_summ(arg1,arg2);
...
extern "C"
#endif
SWIGEXPORT void Init_Rhoelements(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRhoelements = rb_define_module("Rhoelements");
  ...
  rb_define_module_function(mRhoelements, "native_process_string", _wrap_native_process_string, -1);
  rb_define_module_function(mRhoelements, "calc_summ", _wrap_calc_summ, -1);
}
