...
#define SWIG_init    Init_Barcode
#define SWIG_name    "Barcode"

static VALUE mBarcode;
...
extern "C"
#endif
SWIGEXPORT void Init_Barcode(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mBarcode = rb_define_module("Barcode");
  ...
  rb_define_module_function(mBarcode, "native_process_string", _wrap_native_process_string, -1);
  rb_define_module_function(mBarcode, "calc_summ", _wrap_calc_summ, -1);
}
