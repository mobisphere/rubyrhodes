...
extern "C" VALUE rhoelements_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/rhoelements/Rhoelements");
...
extern "C" int rhoelements_calc_summ(int x, int y) {
	return (x+y);
}
